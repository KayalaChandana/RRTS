...
<body>
    ...
    <div class="container">
        ...
        <div class="card" onclick="openReviewForm('complaintreviewform.jsp')">
            <img src="review.jpg" alt="Document Type 2">
            <div class="card-content">
                <h2>Review Complaint</h2>
                <p>Click to open the Review form to enter the Requirements </p>
                <button class="login-button" onclick="openReviewForm('complaintreviewform.jsp')">Open
                    Form</button>
            </div>
    ...
    <div class="container-2">
        <div class="card" onclick="openRepairForm('RoadRepairComplaint.jsp')">
            <img src="fb.jpg" alt="Document Type 1">
            <div class="card-content">
...
<!-- Navigation buttons in top right corner -->
    ...
    <script>
        ...
        function openReviewForm() {
            window.location.href = "complaintreviewform.jsp";
        }
